...
public class StoreServlet extends HttpServlet {
    ...
    public StoreServlet(){
        this.products.put(1,"aaaaaaaaa");
        this.products.put(2,"bbbbbbbbb");
        this.products.put(3,"ccccccccc");
        this.products.put(5,"ddddddddd");
        this.products.put(6,"eeeeeeeee");
    }
